...
from rrnoncecl import mining_nonce, lev
...
def mine_loop():
    ...
    while True:
        ...
        try:
            ...
            current_job = None
            current_job_id = None
            en2_int = en2_size(client.extranonce2_size)
            extranonce2_int = random.randint(0,en2_int)
            need_new_job = True 
            en2_counter = 0
                ...
                for msg in client.poll_message():
                    if msg.get("method") == "mining.notify":
                        ...
                        if new_job_id != current_job_id or new_clean_job:
                            ...
                            rate = ((en2_counter*(256*5120*config["batch_number"]))/elapse_time)/1000000
